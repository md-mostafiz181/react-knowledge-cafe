...
const Blog = ({blog, handleAddToBookmarks, handleAddToMarkRead}) => {
    console.log(blog)
    ...
    return (
        <div className="my-2">
            ...
            <button onClick={()=>handleAddToMarkRead(reading_time)} className="underline text-blue-700 font-bold">Mark as Read</button>
